package com.lfq.mobileoffice.config.aop;
...
public class ViewModelParameterAop {
    ...
    @Pointcut("@annotation(com.lfq.mobileoffice.util.ump.ViewModelParameter)")
    public void viewModelParameter() {
    }

    @Pointcut("@annotation(com.lfq.mobileoffice.util.ump.ViewModelParameters)")
